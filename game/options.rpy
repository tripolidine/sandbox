...
init -1 python hide:
    ...
    #style.window.yminimum = int(float(config.screen_height) * float(window_screen_percentage))
    style.window.yminimum = 0.33
...
python early:
    config.save_directory = "sandbox-1467618042"
